...
{!! Form::open(['route' => 'Nueva-reserva.store', 'method'=>'POST']) !!}
<div class="form-group">
    {{ Form::hidden('mail', $mail, ['class' => 'form-control','readonly'] ) }}
    {{ Form::hidden('tel', $tel, ['class' => 'form-control','readonly'] ) }}
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    {{ Form::text('nombrep', null, ['class' => 'form-control','required'] ) }}
  </div>
  ...
  <div class="form-group">
    ...
    {{ Form::number('cedula', null, ['class' => 'form-control','required'] ) }}
  </div>
 ...
 <!-- <div class="form-group">
    ...
    {{ Form::number('pasajeros', null, ['class' => 'form-control','required','max' => $Cupos,'min'=>'0','step'=>'1'] ) }}
  </div>-->
  ...
  <div class="input-group"> 
    ...
    {{ Form::number('pasajeros', 1, ['class' => 'form-control','required','max' => $Cupos,'min'=>'0','id'=>'pasajeros','readonly'] ) }}
