    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" id="seccion-heading">Registrarse</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <input id="type" type="hidden" name="type" value="pasajero"> 
                            </div>
                        
                            <div class="col-md-6">
                                <input id="plan" type="hidden" name="plan" value="null"> 
                            </div>
                            ...
                            <div class="col-md-6">
                                <input id="cupos" type="hidden" name="cupos" value="null"> 
                            </div>
                        </div>
